...
import AudioModal from './modal/audio';
...
class Product extends Component {
  ...
  componentDidMount = () => {
    const columnsConfig = window.INIT_CONFIG.expenseConfig.CommonService2['rtc'].columns;
  ...
  render() {
    return (
      <div>
        ...
        />
        <VideoModal
          visible={this.state.visible.video}
          target={this.state.target}
          data={this.state.rowData}
          update={this.getDate}
        />
        <AudioModal
          visible={this.state.visible.audio}
          target={this.state.target}
          data={this.state.rowData}
          update={this.getDate}
        />
