    ...
    return (
      <div>
        ...
        >
          ...
          <br /><br />
          &nbsp;&nbsp;&nbsp;&nbsp;{window.INIT_CONFIG.expenseConfig.Region['cn-north-1']}：
          <InputNumber
            min={0}
            placeholder="请输入价格"
            value={this.state.billingMethod['cn-north-1'].Value}
            onChange={price => {
              let billingMethod = { ...this.state.billingMethod };
              billingMethod['cn-north-1'].Value = price;
              this.setState({
                billingMethod
              });
            }}
          ...
          {window.INIT_CONFIG.expenseConfig.Region['ap-singapore-1']}：
          <InputNumber
            min={0}
            placeholder="请输入价格"
            value={this.state.billingMethod['ap-singapore-1'].Value}
            onChange={price => {
              let billingMethod = { ...this.state.billingMethod };
              billingMethod['ap-singapore-1'].Value = price;
              this.setState({
                billingMethod
              });
            }}
